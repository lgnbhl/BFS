...
Caching and path gestion is handled using the new `pins` package. To leverage the `pins` package, you can learn more [here](https://rstudio.github.io/pins/){target="_blank"}.
