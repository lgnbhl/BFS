...
To search and download data from the Swiss Federal Statistical Office, you first need to retrieve information about the available public datasets from the [data catalog](https://www.bfs.admin.ch/bfs/de/home/statistiken/kataloge-datenbanken/daten.html).

You can get the complete data catalog by language, i.e. "en" for English, "de" for German (default), "fr" for French and "it" for Italian.
