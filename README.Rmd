...
To get data from the [Swiss Stats Explorer API](https://stats.swiss/) (SSE) you first create a query using the metadata codelist from SSE using the `bfs_get_sse_metadata()` function. First get the codelist of a BFS dataset:
