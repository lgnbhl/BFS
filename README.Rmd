...
Caching and path gestion will be improved in the next package release using the `pins` package (for now only available on Github). You can try it by installing the development version of the package from Github.
