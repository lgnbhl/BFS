...
Due to a bug in the last version of `tidyRSS`, be sure to use only `tidyRSS` version 2.0.4. If you use the last version of `tidyRSS`, you will see this message.
