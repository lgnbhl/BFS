...
Data caching is handled using the [pins](https://pins.rstudio.com/) R package. To open the folder containing all the BFS datasets you alreaded downloaded, you can use the `bfs_open_dir()` function.
