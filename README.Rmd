...
You can then easily read and visualize geodata, for example using "sf" and "ggplot2".
...
Alternatively you can use the R package "mapview" to create an interactive map.
...
You can also download [cartographic base maps](https://www.bfs.admin.ch/bfs/en/home/statistics/regional-statistics/base-maps/cartographic-bases.assetdetail.24025646.html) using `bfs_download_asset()` (only in the GitHub development version for now). For instance you can get the communes and the main lakes.
