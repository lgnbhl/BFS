...
A lot of data is not accessible through the API, but is still present in the official BFS website. You can access the RSS tables catalog of the Excel files using the `bfs_get_catalog_tables()`. Note that only a part of the tables are accessible using the RSS feed.
