...
You can also download [cartographic base files](https://www.bfs.admin.ch/bfs/en/home/statistics/regional-statistics/base-maps/cartographic-bases.assetdetail.24025646.html) using `bfs_download_asset()` (only in the GitHub development version for now). For instance you can add the main lakes.
