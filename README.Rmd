...
Note that the development version of BFS on Github allows the user to choose the language (German, French, Italian or English) in which the dataset is translated.
