...
To open the folder containing the downloaded BFS dataset, you can simply use the `bfs_open_dir()` function.

```{r, eval = FALSE}
bfs_open_dir()
```

Caching and path gestion is handled using the new `pins` package. To take full advantage of the `pins` package, you can learn more [here](https://rstudio.github.io/pins/){target="_blank"}.
