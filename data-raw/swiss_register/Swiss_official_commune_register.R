...
# create dictionary
register_dic_de <- readxl::read_excel(path = register_path, 
                                   sheet = "01.01.2023", 
                                   col_names = c("title", "abbreviation", "spec", "notes"),
                                   range = "A5:D13")
register_dic_de$language <- "de"
register_dic_fr <- readxl::read_excel(path = register_path, 
                                      sheet = "01.01.2023", 
                                      col_names = c("title", "abbreviation", "spec", "notes"),
                                      range = "A19:D27")
register_dic_fr$language <- "fr"
register_dic_it <- readxl::read_excel(path = register_path, 
                                      sheet = "01.01.2023", 
                                      col_names = c("title", "abbreviation", "spec", "notes"),
                                      range = "A33:D41")
