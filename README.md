...
```
    ...
    ## # A tibble: 202 × 10
    ##    title          language number_asset publication_date order_nr url_px url_bfs
    ##    <chr>          <chr>    <chr>        <date>           <chr>    <chr>  <chr>  
    ##  1 Air emissions… en       32331273     2024-09-26       px-x-02… https… https:…
    ##  2 Deaths per mo… en       32506839     2024-09-26       px-x-01… https… https:…
    ##  3 Divorces and … en       32506841     2024-09-26       px-x-01… https… https:…
    ##  4 Energy accoun… en       32331272     2024-09-26       px-x-02… https… https:…
    ##  5 Live births p… en       32506840     2024-09-26       px-x-01… https… https:…
    ##  6 Marriages and… en       32506838     2024-09-26       px-x-01… https… https:…
    ##  7 New registrat… en       32466294     2024-09-16       px-x-11… https… https:…
    ##  8 Hotel sector:… en       32427368     2024-09-05       px-x-10… https… https:…
    ##  9 Hotel sector:… en       32427369     2024-09-05       px-x-10… https… https:…
    ## 10 Hotel sector:… en       32427370     2024-09-05       px-x-10… https… https:…
    ## # ℹ 192 more rows
...
```
    ...
    ##   title           language number_asset publication_date order_nr url_px url_bfs
    ##   <chr>           <chr>    <chr>        <date>           <chr>    <chr>  <chr>  
    ## 1 University of … en       31306033     2024-03-28       px-x-15… https… https:…
    ## 2 University of … en       31306029     2024-03-28       px-x-15… https… https:…
    ## 3 University stu… en       31305852     2024-03-28       px-x-15… https… https:…
    ## 4 University stu… en       31305854     2024-03-28       px-x-15… https… https:…
    ## # ℹ 3 more variables: language_available <list>, url_structure_json <chr>,
    ## #   damId <int>
...
```
    ...
    ## # ℹ 2 more variables: url_bfs <chr>, damId <int>
