...
ggplot() + 
  geom_sf(data = communes_sf, color = "grey85") + 
  geom_sf(data = lakes_sf, fill = "lightblue2", color = "lightblue2") +
  geom_sf(data = districts_sf, fill = "transparent", color = "grey55") + 
  geom_sf(data = cantons_sf, fill = "transparent", color = "grey20") +
  geom_sf(data = switzerland_sf, fill = "transparent", color = "black") + 
  geom_sf(data = cantons_capitals_sf, color = "red") +
  theme_minimal() +
